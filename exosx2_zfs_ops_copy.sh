...
MACH2_WWN_BASE='wwn-0x5000c500e'
...
MACH2_LUNS=( $(ls /dev/disk/by-id/${MACH2_WWN_BASE}* 2>/dev/null | grep -v part || true ) )
...
TARGET_LUNS=(${MACH2_LUNS[*]})
TARGET_LUN_CNT=${#TARGET_LUNS[*]}
TARGET_DRV_ID=${MACH2_BASE}
